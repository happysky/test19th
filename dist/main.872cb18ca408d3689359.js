...
var _index2 = __webpack_require__(/*! ../css/index.css */ "./src/css/index.css");
...
var questions1 = [{
    ...
    item: ['两步走', '三步走', '四步走', '五步走'],
    answer: 'A'
}, {
    title: '新时代中国特色社会主义思想，明确中国特色社会主义最本质的特征是____。',
    item: ['“五位一体”总体布局', '建设中国特色社会主义法治体系', '人民利益为根本出发点', '中国共产党领导'],
    answer: 'D'
}, {
    title: '发展是解决我国一切问题的基础和关键，发展必须是科学发展，必须坚定不移贯彻____的发展理念。',
    item: ['创新、协调、绿色、开放、共享', '创造、协调、生态、开放、共享', '创新、统筹、绿色、开放、共享', '创造、统筹、生态、开放、共享'],
    answer: 'A'
}, {
    title: '____是中国特色社会主义的本质要求和重要保障。',
    item: ['全面依法治国', '全面从严治党', '全面发展经济', '全面可持续发展'],
    answer: 'A'
}, {
    ...
    item: ['为什么人', '执政宗旨', '建党宗旨', '权力来源'],
    answer: 'A'
}, {
    title: '建设______是中华民族伟大复兴的基础工程。',
    item: ['经济强国', '政治强国', '教育强国', '文化强国'],
    answer: 'C'
}, {
    title: '国家安全是安邦定国的重要基石，______是全国各族人民根本利益所在。',
    item: ['加快经济发展', '维护国家统一', '促进国际合作', '维护国家安全'],
    answer: 'D'
}, {
    title: '我们要建设的现代化是人与自然_____的现代化。',
    item: ['和谐相处', '和睦相处', '和谐共生', '和睦共生'],
    answer: 'C'
}, {
    title: '加快建立绿色生产和消费的法律制度和政策导向，建立健全____的经济体系。',
    item: ['绿色低碳循环发展', '绿色节约循环发展', '绿色低碳节约发展', '节约低碳循环发展'],
    answer: 'A'
}, {
    title: '加强对生态文明建设的总体设计和组织领导，设立________机构。',
    item: ['国有自然资源资产管理和自然环境监管', '国有自然资源资产管理和自然生态监管', '国有自然资源资产监管和自然生态管理', '国有自然环境资产监管和自然生态管理'],
    answer: 'B'
}, {
    title: '我们要牢固树立社会主义生态文明观，推动形成______现代化建设新格局，为保护生态环境作出我们这代人的努力！',
    item: ['人与自然和谐共生', '人与环境和谐发展', '人与自然和谐发展', '人与环境和谐共生'],
    answer: 'C'
}, {
    title: '适应世界新军事革命发展趋势和国家安全需求，提高建设质量和效益，确保到二〇二〇年基本实现____，____建设取得重大进展，____有大的提升。',
    item: ['现代化　信息化　战斗能力', '机械化　信息化　战斗能力', '机械化　信息化　战略能力', '现代化　信息化　战略能力'],
    answer: 'C'
}, {
    title: '力争到二〇三五年____国防和军队现代化，到本世纪中叶把人民军队____世界一流军队。',
    item: ['全面实现　基本建成', '全面实现　全面建成', '基本实现　基本建成', '基本实现　全面建成'],
    answer: 'D'
}, {
    ...
    item: ['战斗力', '斗争力', '战争力', '硬实力'],
    answer: 'A'
}, {
    title: '解决台湾问题、实现祖国完全统一，是全体中华儿女____，是中华民族____所在。',
    item: ['一致愿望　根本利益', '共同愿望　本质利益', '一致愿望　本质利益', '共同愿望　根本利益'],
    answer: 'D'
}, {
    title: '______是两岸关系的政治基础。',
    item: ['“九二共识”', '反对“台独”', '一个中国原则', '和平统一'],
    answer: 'C'
}, {
    title: '我们呼吁，各国人民同心协力，构建人类命运共同体，建设______的世界。',
    item: ['持久和平、普遍安全、共同繁荣、开放包容、公平正义', '持久和平、普遍安全、共同繁荣、公平正义、清洁美丽', '持久和平、普遍安全、共同繁荣、开放包容、清洁美丽', '持久和平、普遍安全、公平正义、开放包容、清洁美丽'],
    answer: 'C'
}, {
    title: '深刻认识党面临的________的尖锐性和严峻性，坚持问题导向，保持战略定力，推动全面从严治党向纵深发展。',
    item: ['精神懈怠危险、能力不足危险、脱离群众危险、消极腐败危险', '精神懈怠危险、封闭僵化危险、脱离群众危险、消极腐败危险', '精神懈怠危险、能力不足危险、官僚主义危险、消极腐败危险', '精神懈怠危险、能力不足危险、脱离群众危险、腐化堕落危险'],
    answer: 'A'
}, {
    title: '党的____是党的根本性建设，决定党的建设方向和效果。',
    item: ['思想建设', '政治建设', '组织建设', '制度建设'],
    answer: 'B'
}, {
    title: '要尊崇党章，严格执行新形势下党内政治生活若干准则，增强党内政治生活的____。',
    item: ['政治性、时代性、原则性、战斗性', '思想性、政治性、时代性、原则性', '政治性、思想性、时代性、原则性', '政治性、思想性、时代性、战斗性'],
    answer: 'A'
}, {
    title: '坚决防止和反对_________，坚决防止和反对宗派主义、圈子文化、码头文化，坚决反对搞两面派、做两面人。',
    item: ['个人主义、享乐主义、自由主义、本位主义、好人主义', '个人主义、分散主义、山头主义、本位主义、好人主义', '个人主义、分散主义、自由主义、本位主义、好人主义', '个人主义、分散主义、自由主义、本位主义、享乐主义'],
    answer: 'C'
}, {
    title: '_____和_____，是中国共产党人的精神支柱和政治灵魂，也是保持党的团结统一的思想基础。',
    item: ['共产主义远大理想　新时代中国特色社会主义共同理想', '共产主义远大理想　中国特色社会主义共同理想', '共产主义崇高理想　新时代中国特色社会主义共同理想', '共产主义崇高理想　中国特色社会主义共同理想'],
    answer: 'B'
}, {
    title: '要坚持党管干部原则，_____，把好干部标准落到实处。',
    item: ['坚持立场坚定、素质过硬，坚持五湖四海、任人唯贤，坚持事业为上、公道正派', '坚持德才兼备、以德为先，坚持立场坚定、素质过硬，坚持事业为上、公道正派', '坚持德才兼备、以德为先，坚持五湖四海、任人唯贤，坚持立场坚定、素质过硬', '坚持德才兼备、以德为先，坚持五湖四海、任人唯贤，坚持事业为上、公道正派'],
    answer: 'D'
}, {
    title: '要以提升____为重点，突出政治功能，把企业、农村、机关、学校、科研院所、街道社区、社会组织等基层党组织建设成为宣传党的主张、贯彻党的决定、领导基层治理、团结动员群众、推动改革发展的坚强战斗堡垒。',
    item: ['凝聚力', '领导力', '组织力', '战斗力'],
    answer: 'C'
}, {
    title: '要坚持无禁区、全覆盖、零容忍，坚持_______，坚持受贿行贿一起查，坚决防止党内形成利益集团。',
    item: ['重预防、强高压、长震慑', '重遏制、强高压、长震慑', '重遏制、不减压、长震慑', '重遏制、强高压、长威慑'],
    answer: 'B'
}, {
    title: '增强党自我净化能力，根本靠强化____和____。',
    item: ['党的自我监督　舆论监督', '党的自我监督　群众监督', '党的自我监督　司法监督', '党的自我监督　民主监督'],
    answer: 'B'
}, {
    title: '推进_____，建设覆盖纪检监察系统的检举举报平台。强化不敢腐的震慑，扎牢不能腐的笼子，增强不想腐的自觉，通过不懈努力换来海晏河清、朗朗乾坤。',
    item: ['监察领域国家立法', '预防腐败国家立法', '反腐败国家立法', '廉政国家立法'],
    answer: 'C'
}];

var questions2 = [{
    title: '全党同志一定要永远与人民____、____、____，永远把人民对美好生活的向往作为奋斗目标，以永不懈怠的精神状态和一往无前的奋斗姿态，继续朝着实现中华民族伟大复兴的宏伟目标奋勇前进。',
    item: ['同呼吸', '共命运', '手牵手', '心连心'],
    answer: 'ABD'
}, {
    title: '过去五年，开放型经济新体制逐步健全，____、____、____稳居世界前列。',
    item: ['对外贸易', '对外投资', '外汇储备', '外汇支出'],
    answer: 'ABC'
}, {
    title: '科学立法、严格执法、公正司法、全民守法深入推进，____、____、____建设相互促进，中国特色社会主义法治体系日益完善，全社会法治观念明显增强。',
    item: ['法治生活', '法治国家', '法治政府', '法治社会'],
    answer: 'BCD'
}, {
    title: '引导应对气候变化国际合作，成为全球生态文明建设的重要____、____、____。',
    item: ['参与者', '贡献者', '引领者', '领导者'],
    answer: 'ABC'
}, {
    title: '出台中央八项规定，严厉整治____、____、____和____，坚决反对特权。',
    item: ['形式主义', '官僚主义', '享乐主义', '奢靡之风', '个人主义'],
    answer: 'ABCD'
}, {
    title: '五年来，我们勇于面对党面临的重大风险考验和党内存在的突出问题，以顽强意志品质正风肃纪、反腐惩恶，消除了党和国家内部存在的严重隐患，党内政治生活气象更新，党内政治生态明显好转，党的_______显著增强。',
    item: ['创造力', '创新力', '凝聚力', '战斗力'],
    answer: 'ACD'
}, {
    title: '坚持______的要求，开展党的群众路线教育实践活动和“三严三实”专题教育，推进“两学一做”学习教育常态化制度化，全党理想信念更加坚定、党性更加坚强。',
    item: ['照镜子', '正衣冠', '洗洗澡', '治治病'],
    answer: 'ABCD'
}, {
    title: '这个新时代，是____。',
    item: ['承前启后、继往开来、在新的历史条件下继续夺取中国特色社会主义伟大胜利的时代', '决胜全面建成小康社会、进而全面建设社会主义现代化强国的时代', '全国各族人民团结奋斗、不断创造美好生活、逐步实现全体人民共同富裕的时代', '全体中华儿女勠力同心、奋力实现中华民族伟大复兴中国梦的时代', '我国日益走近世界舞台中央、不断为人类作出更大贡献的时代'],
    answer: 'ABCDE'
}, {
    title: '全党要更加自觉地增强____、____、____、____，既不走封闭僵化的老路，也不走改旗易帜的邪路，保持政治定力，坚持实干兴邦，始终坚持和发展中国特色社会主义。',
    item: ['道路自信', '理论自信', '制度自信', '文化自信', '思想自信'],
    answer: 'ABCD'
}, {
    title: '新时代中国特色社会主义思想，是_____，必须长期坚持并不断发展。',
    item: ['对马克思列宁主义、毛泽东思想、邓小平理论、“三个代表”重要思想、科学发展观的继承和发展', '马克思主义中国化最新成果', '党和人民实践经验和集体智慧的结晶', '中国特色社会主义理论体系的重要组成部分', '全党全国人民为实现中华民族伟大复兴而奋斗的行动指南'],
    answer: 'ABCDE'
}, {
    title: '新时代坚持和发展中国特色社会主义的基本方略是____。',
    item: ['坚持党对一切工作的领导，坚持以人民为中心，坚持全面深化改革', '坚持新发展理念，坚持人民当家作主，坚持全面依法治国', '坚持社会主义核心价值体系，坚持在发展中保障和改善民生，坚持人与自然和谐共生', '坚持总体国家安全观，坚持党对人民军队的绝对领导，坚持“一国两制”和推进祖国统一', '坚持推动构建人类命运共同体，坚持全面从严治党'],
    answer: 'ABCDE'
}, {
    title: '党政军民学，东西南北中，党是领导一切的。必须增强____，自觉维护党中央权威和集中统一领导，自觉在思想上政治上行动上同党中央保持高度一致。',
    item: ['政治意识', '大局意识', '核心意识', '看齐意识', '纪律意识'],
    answer: 'ABCD'
}, {
    title: '建设一支____、____、____的人民军队，是实现“两个一百年”奋斗目标、实现中华民族伟大复兴的战略支撑。',
    item: ['听党指挥', '骁勇善战', '能打胜仗', '作风优良'],
    answer: 'ACD'
}, {
    ...
    item: ['相互尊重', '公平正义', '互不干涉', '合作共赢'],
    answer: 'ABD'
}, {
    title: '世界正处于大发展大变革大调整时期，和平与发展仍然是时代主题。____、____、____、____深入发展。',
    item: ['世界多极化', '经济全球化', '社会信息化', '文化多样化', '治理民主化'],
    answer: 'ABCD'
}, {
    title: '积极促进“一带一路”国际合作，努力实现____、____、____、____、____，打造国际合作新平台，增添共同发展新动力。',
    item: ['政策沟通', '设施联通', '贸易畅通', '人员互通', '资金融通', '民心相通'],
    answer: 'ABCEF'
}, {
    title: '要深刻认识党面临的____的长期性和复杂性。',
    item: ['执政考验', '改革开放考验', '市场经济考验', '生态保护考验', '外部环境考验'],
    answer: 'ABCE'
}, {
    title: '新时代党的建设总要求是____________。',
    item: ['坚持和加强党的全面领导，坚持党要管党、全面从严治党', '以加强党的长期执政能力建设、先进性和纯洁性建设为主线，以党的政治建设为统领，以坚定理想信念宗旨为根基，以调动全党积极性、主动性、创造性为着力点', '全面推进党的政治建设、思想建设、组织建设、作风建设、纪律建设', '把制度建设贯穿其中，深入推进反腐败斗争，不断提高党的建设质量', '把党建设成为始终走在时代前列、人民衷心拥护、勇于自我革命、经得起各种风浪考验、朝气蓬勃的马克思主义执政党'],
    answer: 'ABCDE'
}, {
    title: '领导十三亿多人的社会主义大国，我们党既要政治过硬，也要本领高强。要_______。',
    item: ['增强学习本领，增强政治领导本领', '增强改革创新本领，增强科学发展本领', '增强依法执政本领，增强群众工作本领', '增强狠抓落实本领，增强驾驭风险本领'],
    answer: 'ABCD'
}, {
    title: '以____、____、____、____、____，把党内和党外、国内和国外各方面优秀人才集聚到党和人民的伟大奋斗中来。',
    item: ['识才的慧眼', '敬才的风度', '爱才的诚意', '用才的胆识', '容才的雅量', '聚才的良方'],
    answer: 'ACDEF'
}, {
    title: '青年兴则国家兴，青年强则国家强。青年一代____、____、____，国家就有前途，民族就有希望。',
    item: ['有品德', '有理想', '有本领', '有担当'],
    answer: 'BCD'
}, {
    title: '全党全国各族人民要紧密团结在党中央周围，高举中国特色社会主义伟大旗帜，锐意进取，埋头苦干，为实现推进现代化建设、完成祖国统一、维护世界和平与促进共同发展三大历史任务，为___________继续奋斗！',
    item: ['决胜全面建成小康社会', '夺取新时代中国特色社会主义伟大胜利', '全面建成社会主义现代化强国', '实现中华民族伟大复兴的中国梦', '实现人民对美好生活的向往'],
    answer: 'ABDE'
}];
...
var app = {
    init: function init() {
        ...
        app.subject_container = (0, _zepto2.default)('.subject');
        app.subject_con = (0, _zepto2.default)('#subject_con');
        app.submit_btn = (0, _zepto2.default)('.buttons .submit');

        app.bindEvent();
    },
    showRemainingTime: function showRemainingTime() {
        var message_con = (0, _zepto2.default)('.message');
        var last_time_con = void 0;
        var total_time = 300; //共5分钟，300秒

        message_con.html('<p>\u5269\u4F59\u65F6\u95F4\uFF1A<span id="last_time">5\u52060\u79D2</span></p>');

        last_time_con = (0, _zepto2.default)('#last_time');

        app.total_timer = setInterval(function () {
            var last_time = --total_time;
            var minute = Math.floor(last_time / 60);
            var second = last_time % 60;
    ...
    showList: function showList() {
        ...
        var subject_container = app.subject_container;
        var submit_btn = app.submit_btn;
        var q_index = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'];
        var htmls = [];
        ...
        if (index > -1) {
            ...
            htmls.push('<ul>');
            question.item.forEach(function (item, index) {
    ...
    showResult: function showResult() {
        var result_container = (0, _zepto2.default)('.result');
        var result_score_con = (0, _zepto2.default)('#score');
        var result_text = '';
        var result_text_con = (0, _zepto2.default)('.result .text');
        var right_count = 0;
        var score = 0;
    ...
    generateQuestion: function generateQuestion() {
        var _questions1 = void 0;
        var _questions2 = void 0;

        var getQuestions = function getQuestions(questions, num) {
            ...
            while (results.length < num) {
                var _index = Math.floor(Math.random() * questions_length);
        ...
        _questions2.forEach(function (item, index) {
            //_questions1的数组长度实时计算，这样插入的能均匀些，否则都在前面
            var _index = Math.floor(Math.random() * _questions1.length);
    ...
    bindEvent: function bindEvent() {
        var first_container = (0, _zepto2.default)('.first');
        var subject_container = app.subject_container;
        var index_button = (0, _zepto2.default)('.index-button');
        var index_input = (0, _zepto2.default)('.index-input');
        var subject_con = app.subject_con;
        var submit_btn = app.submit_btn;

        index_button.on('click', function () {
            var user_name = _zepto2.default.trim(index_input.val());
        ...
        subject_con.on('click', 'li', function (event) {
            var item = (0, _zepto2.default)(event.target);
            var actives_item = void 0;
            var answers = [];
            ...
            //记录答案
            actives_item.forEach(function (item, index) {
                answers.push((0, _zepto2.default)(item).data('index'));
            });
        ...
        submit_btn.on('click', function (event) {
            var button = (0, _zepto2.default)(event.target);
...
__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! D:\product\git\test19th\src\js\app.js */"./src/js/app.js");


/***/ })

},[[0,"manifest","vendor"]]]);
//# sourceMappingURL=main.872cb18ca408d3689359.js.map